...
func SendActivationMail(receiver string, name string, activationId string) {
	...
	templateData := struct {
		...
		Name: name,
		URL: "https://" + conf.Current.Server.Host + ":" + conf.Current.Server.Port + "/api/users/activate/" + activationId,
	}
...
func SendResetPasswordMail(receiver string, name string, activationId string) {
	...
	templateData := struct {
		...
		Name: name,
		URL: "https://" + conf.Current.Server.Host + ":" + conf.Current.Server.Port + "/api/users/reset-password/" + activationId,
	}
	r := NewRequest([]string{receiver}, "Hello "+ name + "!", "Hello "+ name + "!")
