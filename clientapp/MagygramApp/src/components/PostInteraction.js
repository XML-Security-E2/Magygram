                ...
                <ul className="list-inline d-flex flex-row align-items-center m-0">
                    <li className="list-inline-item">
                        <button class="btn p-0">
                            <svg width="1.6em" height="1.6em" viewBox="0 0 16 16" className="bi bi-heart" fill="currentColor">
                    ...
                    <li className="list-inline-item ml-2">
                        <button className="btn p-0">
                            <svg width="1.6em" height="1.6em" viewBox="0 1 16 16" className="bi bi-chat" fill="currentColor">
                    ...
                    <li className="list-inline-item ml-2">
                        <button className="btn p-0">
                            <svg width="1.6em" height="1.6em" viewBox="0 0 16 16" className="bi bi-share" fill="currentColor">
