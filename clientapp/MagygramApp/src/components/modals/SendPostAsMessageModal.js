...
const SendPostAsMessageModal = () => {
	...
	const handleModalClose = () => {
		dispatch({ type: modalConstants.HIDE_SEND_POST_TO_USER_MODAL });
	};
	...
	return (
		<Modal show={messageState.sendPostModal.showModal} aria-labelledby="contained-modal-title-vcenter" centered onHide={handleModalClose}>
...
export default SendPostAsMessageModal;
