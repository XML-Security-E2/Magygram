	...
	return (
		<Modal size="md" show={postState.viewPostModalForGuest.showModal} aria-labelledby="contained-modal-title-vcenter" centered onHide={handleModalClose}>
			<Modal.Body>
				<div className="card">
					<PostHeader
						username={postState.viewPostModalForGuest.post.UserInfo.Username}
						image={postState.viewPostModalForGuest.post.UserInfo.ImageURL}
						id={postState.viewPostModalForGuest.post.UserInfo.Id}
					/>
